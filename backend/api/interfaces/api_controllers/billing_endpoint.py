...
@router.post("/plans", summary="Create a new plan", status_code=status.HTTP_201_CREATED)
...
@router.patch("/plans/{plan_id:path}", summary="Update a existing plan", status_code=status.HTTP_204_NO_CONTENT)
